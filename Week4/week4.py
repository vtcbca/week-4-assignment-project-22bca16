...
def contact():
    try:
        cur.execute('create table if not exists contact(fname text,laname text,contact number,email text,city text)')
        c.commit()
    except Error as e:
        print(e)
def validate():
...
def update():
    try:
         ...
         u="update contact set email='muskan@gmail.com' where fname='muskan'"
         cur.execute(u)
         c.commit()
    except Error as e:
        print(e)
def delete():
    try:
        ...
        d="delete from contact where fname='parthvi'"
        cur.execute(d)
        c.commit()
        c.close()
    except Error as e:
